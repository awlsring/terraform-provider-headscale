...
func (m *V1ExpireMachineResponse) validateMachine(formats strfmt.Registry) error {
...
func (m *V1ExpireMachineResponse) contextValidateMachine(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ExpireMachineResponse) UnmarshalBinary(b []byte) error {
	var res V1ExpireMachineResponse
