...
func (m *V1RegisterMachineResponse) validateMachine(formats strfmt.Registry) error {
...
func (m *V1RegisterMachineResponse) contextValidateMachine(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1RegisterMachineResponse) UnmarshalBinary(b []byte) error {
	var res V1RegisterMachineResponse
