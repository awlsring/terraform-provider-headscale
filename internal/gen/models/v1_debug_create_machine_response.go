...
func (m *V1DebugCreateMachineResponse) validateMachine(formats strfmt.Registry) error {
...
func (m *V1DebugCreateMachineResponse) contextValidateMachine(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1DebugCreateMachineResponse) UnmarshalBinary(b []byte) error {
	var res V1DebugCreateMachineResponse
