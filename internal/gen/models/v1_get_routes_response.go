...
func (m *V1GetRoutesResponse) validateRoutes(formats strfmt.Registry) error {
...
func (m *V1GetRoutesResponse) contextValidateRoutes(ctx context.Context, formats strfmt.Registry) error {
