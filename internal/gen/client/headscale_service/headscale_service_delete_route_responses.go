...
func (o *HeadscaleServiceDeleteRouteOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v1/routes/{routeId}][%d] headscaleServiceDeleteRouteOK %s", 200, payload)
}
...
func (o *HeadscaleServiceDeleteRouteDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/v1/routes/{routeId}][%d] HeadscaleService_DeleteRoute default %s", o._statusCode, payload)
}
