...
func (o *HeadscaleServiceListPreAuthKeysReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewHeadscaleServiceListPreAuthKeysOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewHeadscaleServiceListPreAuthKeysDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewHeadscaleServiceListPreAuthKeysOK() *HeadscaleServiceListPreAuthKeysOK {
	return &HeadscaleServiceListPreAuthKeysOK{}
}
...
func (o *HeadscaleServiceListPreAuthKeysOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v1/preauthkey][%d] headscaleServiceListPreAuthKeysOK %s", 200, payload)
}
...
func (o *HeadscaleServiceListPreAuthKeysOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.V1ListPreAuthKeysResponse)
...
func NewHeadscaleServiceListPreAuthKeysDefault(code int) *HeadscaleServiceListPreAuthKeysDefault {
	return &HeadscaleServiceListPreAuthKeysDefault{
		_statusCode: code,
	}
}
...
func (o *HeadscaleServiceListPreAuthKeysDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v1/preauthkey][%d] HeadscaleService_ListPreAuthKeys default %s", o._statusCode, payload)
}
...
func (o *HeadscaleServiceListPreAuthKeysDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
