...
func (o *HeadscaleServiceDebugCreateNodeOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v1/debug/node][%d] headscaleServiceDebugCreateNodeOK %s", 200, payload)
}
...
func (o *HeadscaleServiceDebugCreateNodeDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v1/debug/node][%d] HeadscaleService_DebugCreateNode default %s", o._statusCode, payload)
}
